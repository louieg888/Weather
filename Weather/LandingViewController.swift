...
class LandingViewController: UIViewController {
    ...
    func addRainOrSunnyIndicator(rain: Bool, rainTime: Int) {
        ...
        rainOrSunnyTime.font = UIFont(name: "Helvetica Neue", size: 60)
    ...
    func addDescriptionTextView(text: String) {
        ...
        descriptionTextView.frame = CGRect(x: Double(0.1*view.frame.width), y: Double(rainOrSunnyTime.frame.maxY + 40), width: Double(0.8*view.frame.width), height: Double(180))
        descriptionTextView.textAlignment = .center
        descriptionTextView.font = UIFont(name: "Helvetica Neue", size: 25)
    ...
    func addAttributionButton() {
        ...
        attributionButton.setTitleColor(UIColor.white, for: .normal)
